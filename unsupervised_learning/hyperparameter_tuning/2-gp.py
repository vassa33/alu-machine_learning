#!/usr/bin/env python3
"""
    Create the class GaussianProcess that represents
...
class GaussianProcess:
    ...
    def update(self, X_new, Y_new):
        """
            ...
            :param X_new: numpy.ndarray of shape (1,) that represents the new
            sample point
            :param Y_new: numpy.ndarray of shape (1,) that represents the new
            sample function value
            :return: No return, just update
        """
